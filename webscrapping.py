...
headers = { 
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:94.0) Gecko/20100101 Firefox/94.0', 'Accept-Language': 'en-US, en;q=0.5' 
    }

search_query = 'laptops' .replace (' ', '+')
base_url = f'https://www.amazon.com/ {search_query}'
...
for i in range (1,5):
    ...
    results = soup.find_all('div', {'class': 's-result-item', 'data-component-type': 's_search_result'})
